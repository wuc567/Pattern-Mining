...
arg_of_dat={}
arg_of_dat["1"]=[150,7,2759,50]
arg_of_dat["2"]=[500,1200,24026,200]
arg_of_dat["3"]=[200,200,4383,80]
arg_of_dat["4"]=[200,100,4383,80]
arg_of_dat["5"]=[600,300,31790,250]
arg_of_dat["6"]=[1500,500,990002,500]
arg_of_dat["7"]=[150,4,773,25]
arg_of_dat["8"]=[150,8,914,50]

'''
参数
'''
filename = "./Datasets/SDB3.txt"  # 数据集 文件路径/文件名
win = 500  # 窗口大小
minsup =500 # 最小支持度阈值
maxlen = 1  # 最长模式的长度
len_init = 0  # 初始数据库中序列个数
seqnum = 4383  # 数据库中序列总长度
step = 150  # 窗口每次滑动的长度
