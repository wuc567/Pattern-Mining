...
int fre_num = 0;
int cd_num = 2;//候选模式数量
int scan_num = 1;//扫描序列次数
int read_num = 0;//访问序列次数
...
int read_file()
{
	...
	//char filename[] = "..\\dataset\\论文投稿.txt";
	//char filename[] = "..\\dataset\\李超然温度.txt";
	//char filename[] = "..\\dataset\\大论文.txt";
...
uint32_t main() {
	...
	char patternfilename[] = "..\\频繁模式\\1.txt";
	//char patternfilename[] = "..\\频繁模式\\2.txt";
