...
"""
# File       : OFP-Over strategy.py
# Time       ：2023/12/23 18:39
# Description：只使用Over strategy策略（频繁提前终止），验证Under strategy剪枝策略（非频繁提前终止）有效性
"""
