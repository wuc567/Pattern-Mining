...
void read_file()
{
	...
	string buff;
	file.open("transaction.txt", ios::in);   //open sequence file
	int i = 0;
...
void main()
{
	...
	cout << "Filter: " << skip << endl;
	cout << "noFilter: " << noskip << endl;
	...
	cout << "BET pruned patterns" << BET << endl;
	cout << "BET cannt pruned patterns" << non_BET << endl;
	...
	cout << "最大共生频繁模式 \n";
	displayCoP(Max_CoP);
	cout << allsigma.size() << endl;
	cout << freq_sigma.size() << endl;
	cout << freq_2pt.size() << endl;
