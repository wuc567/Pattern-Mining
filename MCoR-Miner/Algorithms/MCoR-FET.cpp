...
void read_file()
{
	...
	string buff;
	file.open("msnbc6.txt", ios::in);   //open sequence file
	int i = 0;
...
void enumtree_FETsigma(string prefix, vector <char>& freq_sigma,
...
void main()
{
	...
	enumtree_FETsigma(prefix, freq_sigma, mingap, maxgap, min_sup);
