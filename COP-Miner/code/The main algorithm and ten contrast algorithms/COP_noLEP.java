...
//    private static Double[] p = new Double[]{1.0, 4.0, 3.0,2.0};
...
private static Double[] p = new Double[]{1.0, 6.0, 4.0, 9.0, 7.0, 3.0, 2.0, 5.0};
...
//        File file = new File("E:/Dataset/KURIAS-ECG_PAxis1测试集.txt");




//        File file = new File("E:/Dataset/KURIAS_HeartRate训练集.txt");
        File file = new File("D:/Dataset/NYSE88_88.txt");
...
//        File file = new File("E:/Dataset/1GuangZhouTEMP.txt");
//        File file = new File("E:/Dataset/分类/CSSE1训练集.txt");
//        File file = new File("E:/Dataset/分类/CSSE1测试集.txt");
//                File file = new File("E:/Dataset/分类/CSSE8训练集.txt");
...
//                LNode QNode = getLNode(entry.getValue());
    ...
    private static void grow_BaseP1(LNode qNode, LNode pNode, Double[] Cd, boolean isFirst) {
        ...
        if (isFirst) {
            if (Z.size() >= minsup) {
                freNum++;
                System.out.println("共生模式：" + Arrays.toString(Cd) + ", sup:" + Z.size() );
...
//                System.out.println("共生模式：" + Arrays.toString(Cd) + ", sup:" + Z.size() + ": " + Z.toString());
            ...
            if (Z2.size() >= minsup) {
                freNum++;
                System.out.println("共生模式：" + Arrays.toString(Cd2) + ", sup:" + Z2.size() );
