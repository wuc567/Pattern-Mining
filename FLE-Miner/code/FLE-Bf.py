        ...
        if event_cost.get(key)[0] <= maxeac:  # 平均成本小于阈值
            ...
            for entries in clientNext.values():
                for entry in entries:
                    ...
                    if key in entry:
                        del entry[key]
    return client_candiones, sort_item
...
def mainfun():
    ...
    sup_client, sort_item = onepattern(seqs, neu, cle, client)  # 1序列模式及位置索引,0->1
    ...
    while 1:
        ...
        while i < len(candi):
            ...
            # if candi[i].data == [['01_HOOFD_210_2'], ['03_GBH_005'], ['01_HOOFD_190']]:
