...
def mainfun():
    ...
    # print(activity_chart_r)
    # print(timestamp_list_r)
    # print(cost_list_r)
    ...
    # seqs, timestamp_s = con_seqs(activity_chart_r[0:13], timestamp_list_r[0:13])
    # seqs, timestamp_s = con_seqs(activity_chart_r[13:67], timestamp_list_r[13:67])
    # print(len(seqs))
    # print(len(timestamp_s))
    # 生成效用文件
    # len_line = [len(sublist) for sublist in timestamp_s]
    # print(len(len_line), len_line)
    # write_txt('../dataset/SDB7_NoExt.txt', len_line)
    # 读取效用文件
    ...
    while 1:
        ...
        while i < len(candi):
            ...
            # if candi[i] == [['Receive Result Appeal from Prefecture'], ['Notify Result Appeal to Offender']]:
            #     print(candi[i], eau, ruebound)
            # print(eau, ruebound)
            if eau >= mineau:
